...
function openShareMenu(rec,shareUrl){
  ...
  // Copy the guest-only invitation URL automatically when the share panel opens.
  navigator.clipboard?.writeText(shareUrl).then(()=>toast('Invitation link copied')).catch(()=>{});
