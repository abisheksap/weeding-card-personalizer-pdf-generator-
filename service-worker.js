const CACHE='wedding-studio-v15-vercel-guest-route';
const CORE=['./','./index.html','./css/styles.css','./js/app.js?v=15','./manifest.webmanifest','./assets/card/final-template.pdf','./assets/fonts/NotoSansDevanagari-Regular.ttf','./assets/fonts/NotoSansDevanagari-Bold.ttf','./assets/icons/icon.svg'];
