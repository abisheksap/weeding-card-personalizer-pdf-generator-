...
const TEMPLATE_VERSION='wedding-card-v22-native-share-link';
...
function openSocialShare(rec,shareUrl){
  ...
  $('#shareLinkChoice').onclick=async()=>{
    ...
    if(!ok){openSocialShare(rec,shareUrl);fallbackLinkPanel();toast('Use a social option or Copy link to share the invitation.');}
  };
